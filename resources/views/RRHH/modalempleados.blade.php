            ...
            <div class="modal-body ">
                ...
                <div class="col-md-12 ">
                    ...
                    <div class=" col-sm-4">
                        ...
                        {!! Form::select('departamento',$departamentos,null,['id'=>'departamento','class'=>'form-control','placeholder'=>'Seleccione','onclick'=>'department()']) !!}
                        <div class="text-danger" id="error_departamento"></div>
                    </div>  
                    <div class="col-sm-4">
                        {!! Form::label('Provincia','Provincia',['class'=>'control-label']) !!}
                        {!! Form::select ('provincia',[],null,['id'=>'provincia','class'=>'form-control','placeholder'=>'Seleccione','onclick'=>'province()']) !!}
