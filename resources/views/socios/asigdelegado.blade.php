...
<div class="box box-primary box-solid" >
    <div class="box-header">
        @permission('crear asig delegados')
...
<section id="conten-modal">
    @permission(['crear asig delegados','editar asig delegados'])
            ...
            <div class="modal-body form-horizontal">     
                ...
                <input type="hidden" name="id" id="id" />
                    ...
                    <div class="col-md-5" style="padding-bottom: 10px">
                        ...
                        {!! Form::select('delegado',$delegados,null,['id'=>'delegado','class' =>'form-control','placeholder'=>'Seleccione']) !!}   
                    ...
                    <div class="col-md-12">                        
                        ...
                        <a  id="RegAsigDelegado" class="btn btn-dropbox" style="float: right">Registrar</a>
                    </div>
